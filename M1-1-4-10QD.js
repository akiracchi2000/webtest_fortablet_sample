window.QUIZ_DATA = [
  {
    "question": "$x=a^2+4$ のとき，$\\sqrt{x+4a}$ を簡単にせよ（絶対値を用いて表せ）。",
    "options": [
      "$|a+2|$",
      "$a+2$",
      "$a-2$",
    ...
    "answer": "$|a+2|$",
    "rationale": "$\\sqrt{x+4a} = \\sqrt{\\left(a^2+4\\right)+4a} = \\sqrt{a^2+4a+4}= \\sqrt{\\left(a+2\\right)^2} = |a+2|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "$x=a^2+4$ のとき，$\\sqrt{x-4a}$ を簡単にせよ（絶対値を用いて表せ）。",
  ...
  },
  {
    ...
    "answer": "$|a+1|$",
    "rationale": "$\\sqrt{x+2a} = \\sqrt{\\left(a^2+1\\right)+2a} = \\sqrt{a^2+2a+1}= \\sqrt{\\left(a+1\\right)^2} = |a+1|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "$x=a^2+1$ のとき，$\\sqrt{x-2a}$ を簡単にせよ。",
  ...
  },
  {
    ...
    "answer": "$|a-3|$",
    "rationale": "$\\sqrt{x-6a} = \\sqrt{\\left(a^2+9\\right)-6a} = \\sqrt{a^2-6a+9}= \\sqrt{\\left(a-3\\right)^2} = |a-3|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "$x=a^2+9$ のとき，$\\sqrt{x+6a}$ を簡単にせよ。",
  ...
  },
  {
    ...
    "answer": "$|a+b|$",
    "rationale": "$\\sqrt{x+2ab} = \\sqrt{\\left(a^2+b^2\\right)+2ab} = \\sqrt{a^2+2ab+b^2}= \\sqrt{\\left(a+b\\right)^2} = |a+b|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "$x=a^2+b^2$ のとき，$\\sqrt{x-2ab}$ を簡単にせよ。",
  ...
  },
  {
    ...
    "answer": "$a-3b$",
    "rationale": "$\\sqrt{x-6ab} = \\sqrt{a^2+9b^2-6ab} = \\sqrt{a^2-6ab+\\left(3b\\right)^2}= \\sqrt{\\left(a-3b\\right)^2} = |a-3b|$<br>$a>3b$ より $a-3b > 0$ なので、絶対値はそのまま外せます。<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
  ...
  },
  {
    ...
    "answer": "$a+3b$",
    "rationale": "$\\sqrt{x+6ab} = \\sqrt{a^2+9b^2+6ab} = \\sqrt{a^2+6ab+\\left(3b\\right)^2}= \\sqrt{\\left(a+3b\\right)^2} = |a+3b|$<br>$a>0, b>0$ より $a+3b > 0$ なので、絶対値はそのまま外せます。<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
  ...
  },
  {
    ...
    "answer": "$|a-4|$",
    "rationale": "$\\sqrt{x-8a} = \\sqrt{\\left(a^2+16\\right)-8a} = \\sqrt{a^2-8a+16}= \\sqrt{\\left(a-4\\right)^2} = |a-4|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
  ...
  },
  {
    ...
    "answer": "$|a+2|$",
    "rationale": "$\\sqrt{x+4} = \\sqrt{\\left(a^2+4a\\right)+4} = \\sqrt{a^2+4a+4}= \\sqrt{\\left(a+2\\right)^2} = |a+2|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "answer": "$|a-3|$",
    "rationale": "$\\sqrt{x+9} = \\sqrt{\\left(a^2-6a\\right)+9} = \\sqrt{a^2-6a+9}= \\sqrt{\\left(a-3\\right)^2} = |a-3|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "$x=a^2+1$, $-1 < a < 1$ のとき，$\\sqrt{x+2a}-\\sqrt{x-2a}$ の値を求めよ。",
  ...
  },
  {
    ...
    "answer": "$\\left|a+\\dfrac{1}{2}\\right|$",
    "rationale": "$\\sqrt{x+a} = \\sqrt{a^2+\\dfrac{1}{4}+a} = \\sqrt{a^2+a+\\dfrac{1}{4}}= \\sqrt{\\left(a+\\dfrac{1}{2}\\right)^2} = \\left|a+\\dfrac{1}{2}\\right|$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "answer": "$\\dfrac{1}{2}-a$",
    "rationale": "$\\sqrt{x-a} = \\sqrt{a^2+\\dfrac{1}{4}-a} = \\sqrt{a^2-a+\\dfrac{1}{4}}= \\sqrt{\\left(a-\\dfrac{1}{2}\\right)^2} = \\left|a-\\dfrac{1}{2}\\right|$<br>$a < \\dfrac{1}{2}$ より $a-\\dfrac{1}{2} < 0$ なので、絶対値はマイナスを付けて外します。<br>$\\left|a-\\dfrac{1}{2}\\right| = -\\left(a-\\dfrac{1}{2}\\right) = \\dfrac{1}{2}-a$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63155' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  }
];