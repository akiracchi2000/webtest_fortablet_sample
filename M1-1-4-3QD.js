window.QUIZ_DATA = [
  ...
  },
  {
    ...
    "answer": "$-7+3\\sqrt{3}$",
    "rationale": "$\\left( x+a\\right)\\left( x+b\\right)=x^2+\\left( a+b\\right)x+ab$を利用します。<br>$\\left(\\sqrt{3}\\right)^2 + \\left(5-2\\right)\\sqrt{3} + 5\\cdot \\left(-2\\right) = 3 + 3\\sqrt{3} - 10 = -7 + 3\\sqrt{3}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "answer": "$8+4\\sqrt{5}$",
    "rationale": "$\\left( x+a\\right)\\left( x+b\\right)=x^2+\\left( a+b\\right)x+ab$を利用します。<br>$\\left(\\sqrt{5}\\right)^2 + \\left(1+3\\right)\\sqrt{5} + 1\\cdot 3 = 5 + 4\\sqrt{5} + 3 = 8 + 4\\sqrt{5}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "answer": "$14-7\\sqrt{2}$",
    "rationale": "$\\left( x+a\\right)\\left( x+b\\right)=x^2+\\left( a+b\\right)x+ab$を利用します。<br>$\\left(\\sqrt{2}\\right)^2 + \\left(-3-4\\right)\\sqrt{2} + \\left(-3\\right)\\cdot \\left(-4\\right) = 2 - 7\\sqrt{2} + 12 = 14 - 7\\sqrt{2}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "answer": "$14-6\\sqrt{6}$",
    "rationale": "$\\left( x+a\\right)\\left( x+b\\right)=x^2+\\left( a+b\\right)x+ab$を利用します。<br>$8 - 4\\sqrt{6} - 2\\sqrt{6} + \\left(\\sqrt{6}\\right)^2 = 8 - 6\\sqrt{6} + 6 = 14 - 6\\sqrt{6}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    ...
    "rationale": "$\\left( a+b+c\\right)^2=a^2+b^2+c^2+2ab+2bc+2ca$を利用します。<br>$a=1,b=\\sqrt2,c=\\sqrt3$とします。<br>$1^2+\\left(\\sqrt{2}\\right)^2+\\left(\\sqrt{3}\\right)^2+2 \\cdot 1 \\cdot \\sqrt{2}+2 \\cdot \\sqrt{2} \\cdot \\sqrt{3}+2 \\cdot \\sqrt{3} \\cdot 1 = 1+2+3+2\\sqrt{2}+2\\sqrt{6}+2\\sqrt{3} = 6+2\\sqrt{2}+2\\sqrt{3}+2\\sqrt{6}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "次の式を展開せよ。<br>$\\left(1+\\sqrt{2}-\\sqrt{3}\\right)^2$",
    ...
    "answer": "$6+2\\sqrt{2}-2\\sqrt{3}-2\\sqrt{6}$",
    "rationale": "$\\left( a+b+c\\right)^2=a^2+b^2+c^2+2ab+2bc+2ca$を利用します。<br>$a=1, b=\\sqrt{2}, c=-\\sqrt{3}$ とします。<br>$1^2+\\left(\\sqrt{2}\\right)^2+\\left(-\\sqrt{3}\\right)^2+2 \\cdot 1 \\cdot \\sqrt{2}+2 \\cdot \\sqrt{2} \\cdot (-\\sqrt{3})+2 \\cdot (-\\sqrt{3}) \\cdot 1 = 1+2+3+2\\sqrt{2}-2\\sqrt{6}-2\\sqrt{3}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
    "question": "次の式を展開せよ。<br>$\\left(1-\\sqrt{2}+\\sqrt{3}\\right)^2$",
  ...
  },
  {
    ...
    "options": [
      ...
      "$10+\\sqrt{6}+\\sqrt{10}+\\sqrt{15}$",
      "$10$",
      "$10+2\\sqrt{30}$"
    ],
    "answer": "$10+2\\sqrt{6}+2\\sqrt{10}+2\\sqrt{15}$",
    "rationale": "$\\left( a+b+c\\right)^2=a^2+b^2+c^2+2ab+2bc+2ca$を利用します。<br>$a=\\sqrt2,b=\\sqrt3,c=\\sqrt5$とします。<br>$\\left(\\sqrt{2}\\right)^2+\\left(\\sqrt{3}\\right)^2+\\left(\\sqrt{5}\\right)^2+2 \\cdot \\sqrt{2} \\cdot \\sqrt{3}+2 \\cdot \\sqrt{3} \\cdot \\sqrt{5}+2 \\cdot \\sqrt{5} \\cdot \\sqrt{2} = 2+3+5+2\\sqrt{6}+2\\sqrt{15}+2\\sqrt{10}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
  ...
  },
  {
    ...
    "answer": "$-4$",
    "rationale": "$\\left(\\sqrt{5}-\\sqrt{7}\\right)\\left(2\\sqrt{7}+2\\sqrt{5}\\right) = \\left(\\sqrt{5}-\\sqrt{7}\\right) \\times 2\\left(\\sqrt{7}+\\sqrt{5}\\right)$<br>$= 2\\left(\\sqrt{5}-\\sqrt{7}\\right)\\left(\\sqrt{5}+\\sqrt{7}\\right)  = 2\\left\\{ \\left( \\sqrt5\\right)^2-\\left( \\sqrt7\\right)^2\\right\\} = 2\\left(5-7\\right) = 2\\left(-2\\right) = -4$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  },
  {
  ...
  },
  {
    ...
    "answer": "$7+2\\sqrt{10}$",
    "rationale": "$\\left( x+a\\right)\\left( x+b\\right)=x^2+\\left( a+b\\right)x+ab$を利用します。<br>$\\left(\\sqrt{10}\\right)^2 + \\left(-1+3\\right)\\sqrt{10} + \\left(-1\\right)\\cdot \\left(3\\right) = 10 + 2\\sqrt{10} - 3 = 7 + 2\\sqrt{10}$<br> <strong>↓「学びエイド」の解説動画で確認</strong> <br><a href='https://www.manabi-aid.jp/lesson/id/7710/63137' target='_blank'>解説動画を見る</a><br><small>（※学びエイドのログインが必要です）</small>",
    "answerIndex": 0
  }
];